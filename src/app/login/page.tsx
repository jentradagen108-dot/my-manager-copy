...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Emergency SUPERADMIN login
    if (username.toUpperCase() === 'SUPERADMIN' && password === 'farika@2024') {
        const superAdminData: UserData = {
            id: 'SUPERADMIN_EMERGENCY',
            username: 'SUPERADMIN',
            nik: '000000',
            jabatan: 'SUPER ADMIN',
            lokasi: 'KANTOR PUSAT',
        ...
        toast({
            title: `Selamat Datang, ${superAdminData.username}!`,
            description: 'Anda login menggunakan akun darurat.',
        });
        router.push('/admin');
        setIsLoading(false);
        return;
